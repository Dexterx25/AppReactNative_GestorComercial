...
const {values, isSubmitting, setFieldValue, handleSubmit, errors} = useFormik({
  ...
  onSubmit: values =>{
    console.log(values)
      ...
      if(!values.description||!values.typeActivity||!values.BusineID||!values.date||!values.time) 
  ...
  validate:  values =>{
     ...
     if(values.description.length<10||!values.description) 
   {
    ...
    if(values.BusineID.length<10||!values.BusineID){
       errors.BusineID = "Invalid Date";
      }
  ...
  // createHomeStak = () =>
        ...
        return(
            ...
            <View style={styles.container}>
              ...
              <Text style={styles.welcome}>The Activity Register Busine</Text>
                  ...
                  <Item  error={errors.BusineID ? true : false}>
                    <Label>Your Id Busine:</Label>         
                    <Input value={values.BusineID} onChangeText={text => setFieldValue('BusineID', text)}/>
                  </Item>
